...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('admin/supplier/update/third/' . base64_encode($supplier[0]['id_supplier'])) ?>" method="POST">
            <div class="card-body">
                ...
                <div class="mt-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Bidang Usaha" name="business_major" value="<?= $supplier[0]['business_major'] ?>" required />
                            ...
                            <div class="col-xxl-4 col-lg-6 col-sm-12">
                                <div class="form-check">
                                    ...
                                    foreach ($supplier_product as $row) {
                                        array_push($sup_product, $row['id_product']);
                                    }
                                    ?>
                                    <input class="form-check-input cb-product" type="checkbox" value="<?= $product['id'] ?>" id="product" name="product[]" <?= in_array($product['id'], $sup_product) ? 'checked' : '' ?> />
                        ...
                        <?php foreach ($service as $service) :  ?>
                            <div class="col-xxl-4 col-lg-6 col-sm-12">
                                <div class="form-check">
                                    ...
                                    // dd($supplier_product);
                                    $sup_service = [];
                                    foreach ($supplier_service as $row) {
                                        array_push($sup_service, $row['id_service']);
                                    }
                                    ?>
                                    <input class="form-check-input cb-service" type="checkbox" value="<?= $service['id'] ?>" id="service" name="service[]" <?= in_array($service['id'], $sup_service) ? 'checked' : '' ?> />
                                    <label class="form-check-label">
                                        <?= $service['name'] ?>
                                    </label>
                                </div>
            ...
            <div class="card-footer d-flex justify-content-between" id="buttonContainer">
                <a href="<?= base_url('admin/supplier/edit/second/' . base64_encode($supplier[0]['id_supplier'])) ?>">
