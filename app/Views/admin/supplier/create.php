...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('admin/supplier/create') ?>" method="post" enctype="multipart/form-data" id="supplierform">
            <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Nama" name="name" onkeyup="removeInvalid(this)" value="<?= old('name') ?>" />
                        ...
                        <div class="col-lg-6 mt-lg-0 mt-4">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control p-2 shadow-sm email-required" placeholder="Email" name="email" onkeyup="removeInvalid(this)" value="<?= old('email') ?>" />
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="(+62) 456 - 7890" name="phone_number" onkeyup="removeInvalid(this)" value="<?= old('phone_number') ?>" />
                                <div class="invalid-feedback" id="invalidEmail">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Perusahaan" name="company" onkeyup="removeInvalid(this)" value="<?= old('company') ?>" />
                                <div class="invalid-feedback" id="invalidEmail">
                        ...
                        <div class="col-lg-12 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="WhatsApp" name="whatsapp" value="<?= old('whatsapp') ?>" />
                                <div class="invalid-feedback" id="invalidEmail">
                        ...
                        <div class="col-lg-12 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm" placeholder="Facebook" name="facebook" value="<?= old('facebook') ?>" />
                        ...
                        <div class="col-lg-12 mt-4">
                            <div class="form-group">
                                <label class="form-label fw-bolder">Instagram
                                    <span class="tr-text-primary shadow-sm">*</span></label>
                                <input type="text" class="form-control p-2 shadow-sm" placeholder="Instagram" name="instagram" value="<?= old('instagram') ?>" />
                                <div class="form-text tr-text-primary">
                                    *Opsional.
                                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Alamat Lengkap" name="address" onkeyup="removeInvalid(this)" value="<?= old('address') ?>" />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="zip_code" class="form-control p-2 shadow-sm input-required" placeholder="Kode Pos" list="zip_code" onkeyup="removeInvalid(this)" value="<?= old('zip_code') ?>">
                                <datalist id="zip_code" id="zip_code">
                                </datalist>
                ...
                <div class="tab-step">
                    ...
                    <div class="mt-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Bidang Usaha" name="business_major" valueonkeyup="removeInvalid(this)" value="<?= old('business_major') ?>" />
                            <div class="invalid-feedback">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row">
                            <?php foreach ($product_and_service as $row) :  ?>
                                <div class="col-xxl-4 col-lg-6 col-sm-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="<?= $row['id'] ?>" id="<?= $row['name'] ?>" name="product_and_service[]" />
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Nama Produk" name="product_name" onkeyup="removeInvalid(this)" value="<?= old('product_name') ?>" />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-12 mt-4">
                            <div class="form-group">
                                ...
                                <textarea name="product_description" id="" cols="30" rows="3" class="form-control p-2 shadow-sm" placeholder="Deskripsi Produk"><?= old('product_description') ?></textarea>
                            </div>
                        </div>
                        <div class="col-12 mt-4">
                            <label class="form-label fw-bolder">Harga per Satuan</label>
                            <div class="input-group">
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Harga" name="price" onkeyup="removeInvalid(this)" value="<?= old('price') ?>" />
                                <div class="input-group-append">
                                    <span class="input-group-text">/</span>
                                </div>
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Satuan" list="unit" name="unit" onkeyup="removeInvalid(this)" value="<?= old('unit') ?>" />
                                <datalist id="unit">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Kapasitas" name="capacity" onkeyup="removeInvalid(this)" value="<?= old('capacity') ?>" />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="quality" class="form-control p-2 shadow-sm input-required" placeholder="Kualitas" onkeyup="removeInvalid(this)" value="<?= old('quality') ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p-2 shadow-sm input-required" placeholder="Ongkos Kirim" name="shipping_cost" onkeyup="removeInvalid(this)" value="<?= old('shipping_cost') ?>" />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="termin" class="form-control p-2 shadow-sm input-required" placeholder="Termin Pembayaran" list="termin" onkeyup="removeInvalid(this)" value="<?= old('termin') ?>">
                                <datalist id="termin">
                                    <datalist id="termin">
                                        <option value="3 hari"></option>
                                        <option value="10 hari"></option>
                                        <option value="15 hari"></option>
                ...
                <div class="tab-step">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="file" name="company_profile" id="" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf" class="form-control p-2 shadow-sm input-required">
                        <div class="invalid-feedback">
                            Dokumen pendukung tidak boleh kosong.
                        </div>
                        <small class="form-text text-muted">*Document harus pdf atau docx</small>
                    </div>
                    <div class="mt-4">
                        <label class="form-label fw-bolder">Perizinan
                        </label>
                        <input type="file" name="permit" id="" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf" class="form-control p-2 shadow-sm input-required">
                        <div class="invalid-feedback">
                            Dokumen pendukung tidak boleh kosong.
                        </div>
                        <small class="form-text text-muted">*Document harus pdf atau docx</small>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="file" name="catalog" id="" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf" class="form-control p-2 shadow-sm input-required">
                        <div class="invalid-feedback">
                            Dokumen pendukung tidak boleh kosong.
                        </div>
                        <small class="form-text text-muted">*Document harus pdf atau docx</small>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="file" name="lab_test" id="" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf" class="form-control p-2 shadow-sm input-required">
                        <div class="invalid-feedback">
                            Dokumen pendukung tidak boleh kosong.
                        </div>
                        <small class="form-text text-muted">*Document harus pdf atau docx</small>
