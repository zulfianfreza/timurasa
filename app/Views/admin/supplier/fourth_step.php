...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('admin/supplier/save/fourth_step') ?>" method="POST">
            <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mt-4">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="with_shipping_cost[]" id="inlineRadio1" value="true">
                                                        <label class="form-check-label" for="inlineRadio1">Sudah Termasuk Ongkir</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="with_shipping_cost[]" id="inlineRadio2" value="false">
