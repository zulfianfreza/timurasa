...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('admin/supplier/update/fifth/' . base64_encode($supplier[0]['id_supplier'])) ?>" enctype="multipart/form-data" method="POST">
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="offering_letter" id="" cols="30" rows="5" class="form-control p-2 shadow-sm" required><?= $offering_letter[0]->offering_letter ?></textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#myModal" data-toggle="modal">
                                                <button type="button" class="btn btn-danger tr-bg-primary">Hapus</button>
                                            </a>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-confirm modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-center">
                                                    ...
                                                    <form action="<?= base_url('admin/document/delete/' . base64_encode($supplier[0]['id_supplier']) . '/' . base64_encode($element->id)) ?>" method="POST">
                    ...
                    <div class="col-lg-12 mt-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="file" class="form-control p-2 shadow-sm" name="document[]" accept="application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/pdf" />
                            <div class=" invalid-feedback">
                                Nama produk tidak boleh kosong.
                            </div>
                        </div>
            ...
            <div class="card-footer d-flex justify-content-end" id="buttonContainer">
                <a href="<?= base_url('admin/supplier/edit/fourth/' . base64_encode($supplier[0]['id_supplier'])) ?>">
