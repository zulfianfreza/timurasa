...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('admin/supplier/save/first_step') ?>" method="POST">
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-2 shadow-sm" placeholder="Nama" name="name" value="<?= old('name') ?>" required />
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-4">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control p-2 shadow-sm" placeholder="Email" name="email" value="<?= old('email') ?>" required />
